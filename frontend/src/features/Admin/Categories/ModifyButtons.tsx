...
function ModifyButtons<T>({
	...
	return isEditing(record)
		? <>
			<a onClick={saveOnClick} style={{ marginRight: 8 }}>Opslaan</a>
			<Popconfirm
		...
		: <>
			<a onClick={editOnClick} style={{ marginRight: 8 }}>Bewerken</a>
			<Popconfirm onConfirm={deleteOnClick} title="Zeker dat je wil verwijderen?">
