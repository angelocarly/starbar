...
const CreateConsumption: FC<CreateConsumptionProps> = ({
  form,
}: CreateConsumptionProps) => {
  ...
  return (
    <Form form={form}>
      <Modal
        ...
        onOk={async () => {
          const consumption = (await form.validateFields()) as {
            name: string;
            price: number;
          };
      ...
      >
        ...
        <Form.Item
          name="price"
          rules={[{ required: true, message: "Vul een prijs in aub.!" }]}
        >
          <InputNumber
