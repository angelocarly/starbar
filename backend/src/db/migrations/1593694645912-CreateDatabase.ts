...
export class CreateDatabase1593694645912 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "consumption" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "categoryId" integer, CONSTRAINT "PK_90c8f17309014e5d0f244767367" PRIMARY KEY ("id"))`);
